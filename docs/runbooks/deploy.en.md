# Runbook — sdkwork-models deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-models-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-models/bundle`, loads the image, starts
